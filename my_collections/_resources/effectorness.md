...
date: 2020-04-14
---
Naïve CD4+ T cells coordinate the immune response by acquiring an effector phenotype in response to cytokines. Here, we used quantitative proteomics, bulk RNA-seq, and single-cell RNA-seq  to generate a detailed map of cytokine-regulated gene expression programs. For more information, see  <a href="https://doi.org/10.1101/753731" target="_blank">Cano Gamez et al. 2020</a> and our <a class="text-center" href={{ '/projects/effectorness' | relative_url }}>Effectorness project page</a>.
