...
- Scientists mapped the molecular progression of MASLD, uncovering how biological processes driving liver damage change over time, creating a framework for more precise stage-specific therapies.
- They identified a blood biomarker panel that predicts disease progression and outperforms current non-invasive diagnostic tools.
- The work establishes a framework for precision monitoring and future development of targeted therapies for chronic liver disease.
...
## A continuum of molecular changes
...
## Improving non-invasive diagnosis
...
### Publication:
Kamzolas, I., Koutsandreas, T., et al. (2026) <a href="https://www.nature.com/articles/s42255-026-01543-7"> Decoding MASLD Progression: A Molecular Trajectory-Based Framework for Modelling Disease Dynamics.</a> *Nature Metabolism*
